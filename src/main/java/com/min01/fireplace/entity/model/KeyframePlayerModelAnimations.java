...
@OnlyIn(Dist.CLIENT)
public class KeyframePlayerModelAnimations
{
	public static void animate(HierarchicalPlayerModel<?> p_232320_, AnimationDefinition p_232321_, long p_232322_, float p_232323_, Vector3f p_232324_) 
	{
